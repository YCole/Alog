...
public class AEEControlService extends Service {
    private final static String TAG = "MTKLogger/Debugutils";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Utils.logi("AEEControlService", "Received start id " + startId + ": " + intent);
    ...
    public void clearDAL() {
        ...
        Utils.logd(TAG, "Device AEE red screen cleared.");
    ...
    public void cleanData() {
        ...
        Utils.logi(TAG, "Device /data partition cleaned up.");
    ...
    private static StringBuffer systemexec(String command) {
        ...
        try {
            ...
            Utils.logd(TAG, output.toString());
            process.waitFor();
            reader.close();
        } catch (IOException ioe) {
            ioe.printStackTrace();
            Utils.loge(TAG, "Operation failed.");
